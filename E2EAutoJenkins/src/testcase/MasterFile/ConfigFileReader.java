...
public class ConfigFileReader {
	...
	public static String getValueForTheKeywordFromConfigFile(String getData) throws Exception {
		...
		///E2EAutoJenkins/src/testcase/resources/Configuration/config.properties
		try {
			frameworkProperties = new Properties();
			InputStream inputStream = new FileInputStream("src/testcase/resources/Configuration/config.properties");
